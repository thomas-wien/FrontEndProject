...
export let stories = [
  ...
  new story({firstname: "Aleksandar", lastname: "Stefanovski"}, "I decided to start new career, and i start learn 'Full Stack Web Developer'. After my gratitude i find my Job of my Dreems. Im very Thankfully to CodeFactory!", "imgme.png", "aleks.png", true, 0),
