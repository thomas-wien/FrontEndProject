...
export let students = [
  new student({ firstname: "Thomas", lastname: "Netusil" }, "30.04.1967", "finance and accounting assistant", "ISO 17024 certified Trainer, Diplom Coach, SAP, ECDL Core and Advenced Test Master, Frontend WebDev", "Vienna", "FullStackWebDev.at@gmail.com", "de, en, es", "ECDL Advanced, ", "the guy with the black Face Mask", "thomas.jpg", true, "http://netusil.codefactory.live/", 0),
