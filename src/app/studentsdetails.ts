...
export let students = [
  new student({ firstname: "Thomas", lastname: "Netusil" }, "30.04.1967", "finance and accounting assistant", "ISO 17024 certified Trainer, Diplom Coach, SAP, ECDL Core and Advenced Test Master, Frontend WebDev", "Vienna", "FullStackWebDev.at@gmail.com", "de, en, es", "ECDL Advanced, ", "presentations are my thing", "thomas.jpg", "thomas.png", true, "http://netusil.codefactory.live/", 0),
  new student({ firstname: "Marko", lastname: "Schoretits" }, "18.02.1974", "Magisterium Rechtswissenschaften Uni Wien", "FullStack WebDev", "Leopoldau City", "marko@schoretits.com", "hr, de, es, en, fr, it, pl", "1st level support", "\"... let me tell you a story ...\"", "MARKO SCHORETITS-Avatar.png", "itSchoretitsCom.png", true, "http://it.schoretits.com", 1),
  new student({ firstname: "Aleksandar", lastname: "Stefanovski" }, "12.08.1985", "Hochschule", "FullStack Developer", "Straßgschwandtnerstraße", "addastefanovski@gmail.com", "en, de, mk, srb, bg, hr,es", "ECDL Advanced", "The guy with Kilimanjaro Backpack", "imgme.png", "Stefanovski.png", true, "http://stefanovski.codefactory.live/", 2),
