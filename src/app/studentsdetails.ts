...
export let students = [
  new student({ firstname: "Thomas", lastname: "Netusil" }, "30.04.1967", "Volkschule", "FullStack WebDev", "Schloß Schönbrunn", "FullStackWebDev.at@gmail.com", "de, en, es", "ECDL Advanced", "the guy with the black Face Mask", "thomas.jpg", true, "http://netusil.codefactory.live/", 0),
  new student({ firstname: "Marko", lastname: "Schoretits" }, "18.02.1974", "Magisterium Rechtswissenschaften Uni Wien", "FullStack WebDev", "Leopoldau City", "marko@schoretits.com", "hr, de, es, en, fr, it, pl", "1st level support", "\"... let me tell you a story ...\"", "AKO500.png", true, "http://netusil.codefactory.live/", 1),
