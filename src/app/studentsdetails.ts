...
export let students = [
  ...
  new student({ firstname: "Marko", lastname: "Schoretits" }, "18.02.1974", "Magisterium Rechtswissenschaften Uni Wien", "FullStack WebDev", "Leopoldau City", "marko@schoretits.com", "hr, de, es, en, fr, it, pl", "1st level support", "\"... let me tell you a story ...\"", ".png", "", true, "http://netusil.codefactory.live/", 1),
