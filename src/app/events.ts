...
export let events = [
  ...
  new event("Party at Code Factory", "27.04.2023 Start: 5pm", "Join us for a night of celebration at Code Factory! Network with fellow tech enthusiasts, enjoy some drinks and music, and have a great time.", "wallstreet-580.webp", 0, true, 0),
  ...
  new event("Introduction to Data Science", "18.06.2023 & 25.06.2023", "Interested in Data Science? Join us for an introduction to the fundamentals of Data Science, including statistics, data analysis, and machine learning. Our experienced instructors will guide you through hands-on exercises and real-world examples.", "datascience.png", 490, true, 0),
  new event("UX Design Workshop", "01.07.2023 & 08.07.2023", "Learn how to design user-centric digital products with our UX Design Workshop! Our course covers the latest UX design methodologies, including design thinking, prototyping, and user testing.", "uxdesign.png", 790, true, 0),
  new event("Cybersecurity Essentials", "12.08.2023 & 19.08.2023", "Protect yourself and your business from cyber threats with our Cybersecurity Essentials course. Our expert instructors will teach you the fundamentals of cybersecurity, including threat detection and prevention, network security, and cryptography.", "cybersecurity.png", 890, true, 0),
  new event("Cloud Computing", "02.09.2023 & 09.09.2023", "Learn how to harness the power of the cloud with our Cloud Computing course. Our curriculum covers popular cloud platforms like AWS, Azure, and Google Cloud, as well as key concepts like scalability, elasticity, and virtualization.", "cloudcomputing.png", 1290, true, 0),
  new event("Full-Stack Web Development", "23.09.2023 & 30.09.2023", "Become a Full-Stack Web Developer with our intensive course! Our curriculum covers both frontend and backend development, as well as popular frameworks like React, Node.js, and Express.", "fullstack.png", 3990, true, 0),
  new event("Mobile App Development", "14.10.2023 & 21.10.2023", "Learn how to build native mobile apps for iOS and Android with our Mobile App Development course. Our curriculum covers popular app development frameworks like React Native and Flutter, as well as key concepts like UI design and app deployment.", "mobileapp.png", 2490, true, 0),
