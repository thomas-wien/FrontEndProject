...
export let events = [
  new event("Change your career!", "05.03.2023&06.03.2023 Time:9:00", "Meet us at Bestmesse Wieaner Stadthalle Vienna","mese.png", 0, true, 0),
  new event("Basic HTML/CSS course", "11.04.2023&12.04.2023 Time:9:00", "Small changes can change your life", "htmlkurs.png", 299.00, true, 0),
